...
**Is my data secure?**
Yes. All file uploads use time-limited presigned URLs and go to a private, encrypted S3 bucket. No AWS credentials are exposed to the browser. All Lambda functions use least-privilege IAM policies. DynamoDB encryption at rest is enabled by default.
